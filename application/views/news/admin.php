...
<legend>資料列表</legend>
   <table id="addMessage" width="30%" border="1" align="center">
        ...
        <?php  
        foreach($data as $join_data){
        ?>
        <tr>
            <td><?php echo $join_data['news_id']?></td>
            <td><?php echo $join_data['news_title']?></td>
            <td><?php echo $join_data['news_message']?></td>
            <td><?php echo $join_data['user_id']?></td>
            <td><?php echo $join_data['user_name']?></td>
            <td><?php echo $join_data['user_company']?></td>
        </tr>
        <?php  
        }
        ?>
